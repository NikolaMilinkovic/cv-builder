          ...
          <div id="img-name-container">
            ...
            <div id="cv-header-contact-container">
              <div className="icon-text-display">
                <Icon
                  path="img/icons/dark-theme/envelope-dark.svg"
                  alt="Email icon"
              ...
              <div className="icon-text-display">
                <Icon
                  path="img/icons/dark-theme/phone-dark.svg"
                  alt="Phone icon"
                  className={"icon-container"}
                /> 
        ...
        <div>
          <div id="cv-education-container">
            <div className="icon-header-display">
              <Icon
                path="img/icons/dark-theme/graduate-dark.svg"
                alt="Education icon"
          ...
          <div id="cv-experience-container">
            <div className="icon-header-display">
              <Icon
                path="img/icons/dark-theme/briefcase-dark.svg"
                alt="Education icon"
                className={"icon-container-reverse"}
              /> 
